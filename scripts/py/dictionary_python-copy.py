...
# -*- coding: utf-8 -*- #this is for encoding and ASCII in python2.7
import os, sys
import pandas as pd
import re
...
tabela = pd.read_excel('/var/www/html/python2.7_translater_files_geoprocessing/files/for_test_setor.xlsx', enconding='latin-1')
